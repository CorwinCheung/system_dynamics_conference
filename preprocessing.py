...
def year_2016():
    ...
    # slice_3 = dfs_2016[52][3]
    # slice_3b = dfs_2016[52][1]
    ...
    # slice_4 = dfs_2016[55][3]
    # slice_4b = dfs_2016[55][1]
    ...
    # slice_5 = dfs_2016[57][3]
    # slice_5b = dfs_2016[57][1]
    ...
    # slice_7 = dfs_2016[62][3]
    # slice_7b = dfs_2016[62][1]

    # value_counts_dict_7 = {
    #     slice_7b[1]: int(slice_7[1]), slice_7b[2]: int(slice_7[2]), slice_7b[3]: int(slice_7[3])
    # }

    # slice_1 = dfs_2016[72][3]
    # slice_1b = dfs_2016[72][1]
    ...
    value_counts_dicts = {
        ...
        "Have you used the Conference Online Scheduler? The Conference Online Scheduler is available to everyone on the Web Portal Log In page; it shows the entire conference by day and hour.": value_counts_dict_8,
        "If you have used the Conference Online Scheduler, which device have you used? Please check all that apply.": value_counts_dict_9,
        "Have you used your scheduled conference sessions": value_counts_dict_10,
    ...
    #     slice_main = dfs_2016[idx][3]
    #     slice_helper = dfs_2016[idx][1]
    #     value_counts_dict = {
    ...
    #     text_list.append(dfs_2016[i][0][1:].values)
